      ...
      <section className="relative isolate flex min-h-[calc(100svh-6rem)] items-end overflow-hidden bg-brand-ink text-white">
        ...
        <div className="container-site relative z-10 pb-14 pt-20 sm:pb-16 lg:pb-20">
          <Badge className="mb-6 rounded-md border-white/20 bg-white/10 text-white hover:bg-white/10">
            B2B software consulting from Bulgaria
          </Badge>
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-pretty text-white/82 sm:text-xl">
            I help companies design, build, and improve reliable web applications,
            business automations, internal tools, and practical technical systems.
          </p>
      ...
      <section className="section-y bg-background">
        <div className="container-site">
          <SectionHeading
            ...
            description="Start with a practical first version, then scale into backend functionality, automation, data, and client-facing systems when the business case is real."
          />
      ...
      <section className="section-y border-y border-border bg-brand-paper">
        <div className="container-site grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <SectionHeading
            ...
            description="The phase-1 site is built to rank, explain, and convert. The same stack can later support forms, dashboards, databases, portals, email workflows, and private client areas."
          />
        ...
        <div className="container-site">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <SectionHeading
              ...
              description="The case-study structure is ready for real client stories, anonymized examples, measurable outcomes, and technical notes."
            />
      ...
      <section className="section-y border-y border-border bg-brand-paper">
        <div className="container-site">
          <SectionHeading
            ...
            description="The work is structured so business decisions and technical decisions stay connected."
          />
        ...
        <div className="container-site">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <SectionHeading
              ...
              description="Content should attract the right clients by answering real business and technical questions."
            />
            <Button asChild variant="outline" className="h-10 w-fit">
              <Link href="/insights">
                Read insights
      ...
      <section className="border-t border-border bg-background">
        <div className="container-site grid gap-8 py-12 md:grid-cols-[1fr_auto] md:items-center">
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-muted-foreground">
              Send a short description of the business problem, current tools, target
              users, timeline, and what success should look like.
            </p>
          </div>
          <Button asChild variant="outline" className="h-10 w-fit">
